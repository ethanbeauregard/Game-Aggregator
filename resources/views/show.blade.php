  ...
  <div class="container mx-auto px-4">
    ...
    <div class="game-details border-b border-gray-800 pb-12 flex">
      ...
      <div class="ml-12 mr-64">
        ...
        <div class="flex flex-wrap items-center mt-8">
          <div class="flex items-center">
            <div class="w-16 h-16 bg-gray-800 rounded-full">
              <div class="font-semibold text-xs flex justify-center items-center h-full">94%</div>
            </div>
        ...
        <p class="mt-12">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus iure reprehenderit amet officia, blanditiis dolore nesciunt, perferendis aspernatur assumenda accusantium, sint quam obcaecati architecto molestias? Laudantium mollitia laboriosam voluptas non soluta harum.</p>

        <div class="mt-12">
          <button class="flex bg-blue-500 white-text font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
    ...
    <!-- Begin of Game Images  -->
    <div class="images-container border-b border-gray-800 pb-12 mt-8">
      <h2 class="text-blue-500 uppercase tracking-wide font-semibold">Images</h2>
      <div class="grid grid-cols-3 gap-12 mt-8">
        <div>
          <a href="#">
            <img src="/assets/screenshot1.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
          </a>
        </div>

        <div>
          <a href="#">
            <img src="/assets/screenshot2.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
          </a>
        </div>

        <div>
          <a href="#">
            <img src="/assets/screenshot3.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
          </a>
        </div>

        <div>
          <a href="#">
            <img src="/assets/screenshot4.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
          </a>
        </div>

        <div>
          <a href="#">
            <img src="/assets/screenshot5.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
          </a>
        </div>

        <div>
          <a href="#">
            <img src="/assets/screenshot6.jpg" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
          </a>
        </div>
    ...
    <!-- Begin of Similar Games  -->
    <div class="similar-games-container mt-8">
      <h2 class="text-blue-500 uppercase tracking-wide font-semibold">Similar Games</h2>
      <div class="popular-games ml-16 md:ml-0 text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
